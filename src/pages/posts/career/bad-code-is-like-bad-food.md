...
title: 'Bad Code Is Like Bad Food'
pubDate: 2026-05-14
description: 'A reflection on how software engineering habits mirror food habits: fast gratification, long-term consequences, discipline, and why sustainable code quality matters more than short-term convenience.'
isPinned: false
excerpt: "Bad code feels great in the moment, just like bad food. It's quick, convenient, and does the job. The problem is that both quietly accumulate consequences that only become visible much later."
image:
  src: /src/pages/posts/career/_bad-code-is-like-bad-food.jpg
  alt: 'A healthy salad in a bowl'
tags: ['engineering', 'architecture', 'career', 'mindset']
relatedPosts:
...
accreditation:
  handle: https://unsplash.com/@annapelzer
  photographer: Anna Pelzer
  photo: https://unsplash.com/photos/bowl-of-vegetable-salads-IGfIGP5ONV0
  media: Unsplash
---
...
You don't eat one salad and suddenly become healthy.
You don't go to the gym once and transform your body.
You don't stop drinking alcohol for two weeks and suddenly feel ten years younger.
...
Thinking about architecture takes effort.
Refactoring is uncomfortable.
Proper reviews require patience.
...
AI is amazing.
I use it daily.
It genuinely increases productivity.
...
Quick fixes.
Generated abstractions nobody understands.
...
Not perfectly.
Not always.
But generally the signals are visible.
